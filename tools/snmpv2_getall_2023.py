...
from tools.snmpv2_getbulk import snmpv2_getbulk
...
def snmpv2_getall(ip, community, count=25, port=161):
    ...
    mem_free = int(snmpv2_get(ip, community, "1.3.6.1.4.1.9.9.109.1.1.1.1.13.7", port=161)[1])
    mem_use = int(snmpv2_get(ip, community, "1.3.6.1.4.1.9.9.109.1.1.1.1.12.7", port=161)[1])
    ...
    """
    {'cpu_usage': 2,
     'interface_list': [{'interface_in_bytes': 70472037,
                         'interface_name': 'GigabitEthernet1',
                         'interface_out_bytes': 272602,
                         'interface_state': True},
